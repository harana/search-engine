...
pub struct ActionsCreateHostedRunnerForOrgRequest {
    /// Name of the runner. Must be between 1 and 64 characters and may only contain upper and lowercase letters a-z, numbers 0-9, '.', '-', and '_'.
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "image")]
    pub image: Box<models::ActionsCreateHostedRunnerForOrgRequestImage>,
...
impl ActionsCreateHostedRunnerForOrgRequest {
    pub fn new(name: String, image: models::ActionsCreateHostedRunnerForOrgRequestImage, size: String, runner_group_id: i32) -> ActionsCreateHostedRunnerForOrgRequest {
