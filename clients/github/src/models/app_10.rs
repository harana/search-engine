...
impl App10 {
    ...
    pub fn new(created_at: Option<String>, description: Option<String>, external_url: Option<String>, html_url: String, id: Option<i32>, name: String, node_id: String, owner: Option<models::User2>, updated_at: Option<String>) -> App10 {
        App10 {
            created_at,
            description,
            events: None,
