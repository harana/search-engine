...
pub struct CodeSecurityCreateConfigurationForEnterpriseRequest {
...
impl CodeSecurityCreateConfigurationForEnterpriseRequest {
    pub fn new(name: String, description: String) -> CodeSecurityCreateConfigurationForEnterpriseRequest {
