...
pub struct CodeSecurityCreateConfigurationRequest {
    ...
    pub dependency_graph_autosubmit_action_options: Option<Box<models::CodeSecurityCreateConfigurationForEnterpriseRequestDependencyGraphAutosubmitActionOptions>>,
    ...
    #[serde(rename = "secret_scanning_delegated_bypass", skip_serializing_if = "Option::is_none")]
    pub secret_scanning_delegated_bypass: Option<SecretScanningDelegatedBypass>,
    #[serde(rename = "secret_scanning_delegated_bypass_options", skip_serializing_if = "Option::is_none")]
    pub secret_scanning_delegated_bypass_options: Option<Box<models::CodeSecurityCreateConfigurationRequestSecretScanningDelegatedBypassOptions>>,
...
/// The enablement status of secret scanning delegated bypass
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum SecretScanningDelegatedBypass {
    #[serde(rename = "enabled")]
    Enabled,
    #[serde(rename = "disabled")]
    Disabled,
...
impl Default for SecretScanningDelegatedBypass {
    fn default() -> SecretScanningDelegatedBypass {
        Self::Enabled
    }
}
/// The enablement status of secret scanning validity checks
