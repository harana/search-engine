...
pub struct SimplePullRequest3Head {
    ...
    pub repo: Option<Box<models::Repository12>>,
    #[serde(rename = "sha")]
    pub sha: String,
...
impl SimplePullRequest3Head {
    pub fn new(label: Option<String>, r#ref: String, repo: Option<models::Repository12>, sha: String, user: Option<models::User1>) -> SimplePullRequest3Head {
