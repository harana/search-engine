...
pub struct WebhookCodeScanningAlertCreatedAlert {
    ...
    pub dismissal_approved_by: Option<Option<serde_json::Value>>,
}

impl WebhookCodeScanningAlertCreatedAlert {
    /// The code scanning alert involved in the event.
    pub fn new(created_at: Option<String>, dismissed_at: Option<serde_json::Value>, dismissed_by: Option<serde_json::Value>, dismissed_reason: Option<serde_json::Value>, html_url: String, number: i32, rule: models::WebhookCodeScanningAlertClosedByUserAlertRule, state: Option<State>, tool: Option<models::WebhookCodeScanningAlertCreatedAlertTool>, url: String) -> WebhookCodeScanningAlertCreatedAlert {
