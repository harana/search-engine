...
impl WebhookIssuesMilestoned {
    pub fn new(action: Action, issue: models::Issue5, milestone: models::WebhooksMilestone, repository: models::RepositoryWebhooks, sender: models::SimpleUser) -> WebhookIssuesMilestoned {
