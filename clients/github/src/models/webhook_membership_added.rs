...
impl WebhookMembershipAdded {
    pub fn new(action: Action, member: Option<models::WebhooksUser>, organization: models::OrganizationSimpleWebhooks, scope: Scope, sender: Option<models::User2>, team: models::WebhooksTeam) -> WebhookMembershipAdded {
