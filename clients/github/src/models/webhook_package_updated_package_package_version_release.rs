...
impl WebhookPackageUpdatedPackagePackageVersionRelease {
    pub fn new(author: Option<models::User2>, created_at: String, draft: bool, html_url: String, id: i32, name: String, prerelease: bool, published_at: String, tag_name: String, target_commitish: String, url: String) -> WebhookPackageUpdatedPackagePackageVersionRelease {
