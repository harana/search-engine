...
impl WebhookProjectsV2ProjectReopened {
    pub fn new(action: Action, organization: models::OrganizationSimpleWebhooks, projects_v2: models::ProjectsV2, sender: models::SimpleUser) -> WebhookProjectsV2ProjectReopened {
