...
pub struct WebhookPullRequestReviewCommentCreatedPullRequestHead {
    ...
    pub repo: Option<Box<models::Repository7>>,
    #[serde(rename = "sha")]
    pub sha: String,
...
impl WebhookPullRequestReviewCommentCreatedPullRequestHead {
    pub fn new(label: String, r#ref: String, repo: Option<models::Repository7>, sha: String, user: Option<models::User1>) -> WebhookPullRequestReviewCommentCreatedPullRequestHead {
