...
impl WebhookRegistryPackagePublished {
    pub fn new(action: Action, registry_package: models::WebhookRegistryPackagePublishedRegistryPackage, sender: models::SimpleUser) -> WebhookRegistryPackagePublished {
