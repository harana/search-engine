...
impl WebhookWorkflowJobWaiting {
    pub fn new(action: Action, repository: models::RepositoryWebhooks, sender: models::SimpleUser, workflow_job: models::WebhookWorkflowJobWaitingWorkflowJob) -> WebhookWorkflowJobWaiting {
