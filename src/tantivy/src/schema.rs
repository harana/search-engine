...
use harana_common::tantivy::{DateOptions, Score};
use harana_common::hashbrown::{HashMap, HashSet};
use harana_common::log::warn;

use crate::helpers::{Calculated, Validate};

pub static ID_FIELD: &str = "_id";
...
pub struct SchemaContext {
    ...
    #[serde(default)]
    pub boost_fields: HashMap<String, Score>,
...
impl SchemaContext {
    ...
    pub fn as_tantivy_schema(&self) -> Schema {
        ...
        schema.add_u64_field(ID_FIELD, FAST | STORED | INDEXED);
        ...
        for (field, details) in self.fields.iter() {
            ...
            match details {
                ...
                FieldDeclaration::Boolean { opts } => {
                    schema.add_bool_field(field, *opts);
                },
...
impl From<CalculatedIntOptions> for TextOptions {
    fn from(v: CalculatedIntOptions) -> Self {
        let mut opts = TextOptions::default();

        if v.indexed {
            opts = opts.set_indexing_options(TextFieldIndexing::default())
        }
...
pub enum FieldDeclaration {
    ...
    /// A boolean field with given options.
    ///
...
impl FieldDeclaration {
    ...
    pub fn is_required(&self) -> bool {
        match self {
            ...
            FieldDeclaration::Boolean { opts } => opts.base.required,
    ...
    pub fn is_multi(&self) -> bool {
        match self {
            ...
            FieldDeclaration::Boolean { opts } => opts.base.multi,
    ...
    pub fn is_indexed(&self) -> bool {
        match self {
            ...
            FieldDeclaration::Boolean { opts } => opts.indexed,
    ...
    pub fn is_stored(&self) -> bool {
        match self {
            ...
            FieldDeclaration::Boolean { opts } => opts.base.stored,
