...
pub struct PersistentSynonymsManager {
    conn: StorageBackend,
...
impl PersistentSynonymsManager {
    ...
    // TODO add-back #[instrument(name = "synonyms", skip_all)]
    pub fn new(conn: StorageBackend, manager: SynonymsManager) -> Result<Self> {
    ...
    ///
    /// Parses foo,bar,baz:foo,bar,baz into forming a synonym for each item minus itself.
    // TODO add-back #[instrument(name = "synonyms", skip(self))]
