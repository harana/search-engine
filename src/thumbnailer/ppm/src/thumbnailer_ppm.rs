...
pub struct ThumbnailerPpm;

#[async_trait]
impl Thumbnailer for ThumbnailerPpm {
    ...
    async fn thumbnail(&self, source_file: &Path, target_file: &Path, _document_id: u64, _app: &'static AppHandle<Wry>, width: u32, height: u32) -> Result<()> {
        ImageDecoder::standard(source_file, target_file, ImageType::Ppm, false, None, (width, height)).await
    }
...
mod tests {
    ...
    use crate::thumbnailer_ppm::ThumbnailerPpm;
